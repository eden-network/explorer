...
export default function Header({ selected }: { selected?: 'blocks' | 'stakers' | 'slots' | 'producers' }) {
          ...
          <div className="flex items-center px-2 lg:px-0">
            ...
            <div className="hidden lg:block lg:ml-6">
              <div className="flex space-x-4">
                ...
                <a href="#" className={selected === 'slots' ? selectedButton : unselectedButton}>Slots</a>
                <a href="#" className={selected === 'producers' ? selectedButton : unselectedButton}>Producers</a>
              </div>
            </div>
          </div>
